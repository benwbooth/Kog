...
| Partial | Preferences | Real MIDI pane selects, validates, clears, and persists an SF2 SoundFont and identifies the active RustySynth backend | General, appearance, playlist, output, remaining MIDI engines/options, notifications, shortcuts, Last.fm, remote-control, time-stretch, and platform path panes |
