...
| Not started | Preferences | None | General, appearance, playlist, output, MIDI, notifications, shortcuts, Last.fm, remote-control, time-stretch, and platform path panes |
