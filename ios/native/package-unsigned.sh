...
xcrun --sdk "$sdk_name" swiftc -O -D KOG_NATIVE_AUDIO -module-name Kog \
  ...
  -lkog_ios_audio -lkog_sc55_embedded -lkog_sc55_core -lkog_syntrax_embedded -lkog_syntrax_core -lkog_psf2_embedded -lkog_psf2_play_core -lPlayCore -lFramework_Http -lapp_shared -lCodeGen -lFramework -llibzstd_zlibwrapper_static -lxxhash -lchdr-static -lzstd -llzma -lkog_twosf_embedded -lcore -lteakra -lkog_twosf_psflib -lkog_twosf_platform -lbz2 -larchive -lavformat -lavcodec -lavutil -lswresample \
  -lc++ -lz -liconv \
