...
impl RadioRound {
    ...
    pub(crate) fn restore(initial: RoundInitial) -> Self {
        Self {
            seed: initial.seed,
    ...
    pub(crate) fn save(&self, path: &Path, root: &Path, dead: &HashSet<String>) {
    ...
    pub(crate) fn load(path: &Path, root: &Path) -> Option<RoundInitial> {
